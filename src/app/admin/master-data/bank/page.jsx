...
export default function BankDetailsPage() {
  ...
  const normalizeDateForApi = (dateStr) => {
    ...
    // Keep the same date user selected (no timezone shift)
  ...
  const handleSubmit = async (e) => {
    ...
    if (dataCopy.effectiveDate) {
      // dataCopy.effectiveDate = normalizeDateForApi(dataCopy.effectiveDate);
    ...
    try {
      ...
      if (editingItem) {
        ...
        // if (newBankData.effectiveDate) {
        //   newBankData.effectiveDate = formatDateDDMMYYYY(newBankData.effectiveDate);
        // }
    ...
    <Layout role="admin">
      <div className="space-y-6 sm:space-y-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 sm:mb-8">
          <div className="flex-1 min-w-0">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold mb-2">
              <span className="gradient-text">Bank Master</span>
            </h1>
        ...
        <Modal
          ...
          title={editingItem ? `Edit Bank Master` : `Add Bank Master`}
          size="lg"
        >
                          ...
                          if (fieldLower.includes('accountnumber') || fieldLower.includes('account number')) {
                            ...
                            if (fieldLower.includes('gst') && value.length >= 2) {
                              ...
                              if (panRecord) {
                                ...
                                updateFormData('accountName', panRecord.panName);
