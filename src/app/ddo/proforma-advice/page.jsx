...
// //   // Save in localStorage instead of URL params
// //   localStorage.setItem("selectedReceiptsData", JSON.stringify(selectedData));
...
//       // Validation
//       if (edited.amountReceived === "" || isNaN(edited.amountReceived)) {
//         toast.error(`Amount Received is required for PA No: ${original.paNo}`);
//         return;
//       }
...
//     //         onChange={(e) => updateField(row.id, "paymentMode", e.target.value)}
//     //       >
//     //         <option value="Bank">Bank/ DD/ Cheque</option>
...
// //   const encodedData = encodeURIComponent(JSON.stringify(selectedData));
// //   router.push(`/ddo/shortfall_payment_preview?shortfalldata=${encodedData}`);
// // };
// const handleNext = () => {
//   if (selectedReceipts.length === 0) {
//     toast.error("Please select at least one receipt");
