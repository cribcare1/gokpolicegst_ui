      ...
      <div className="w-full max-w-md backdrop-blur-xl bg-white/98 p-8 sm:p-10 my-8 rounded-3xl shadow-2xl border border-white/30 relative z-10">
        ...
        <div className="text-center mb-8 space-y-4">
          ...
          <div className="space-y-2">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold bg-gradient-to-r from-teal-600 via-emerald-600 to-teal-600 bg-clip-text text-transparent leading-tight">Admin Sign in</h2>
