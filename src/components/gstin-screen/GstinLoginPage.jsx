        ...
        {isLogin ? (
          <form className="mt-6 sm:mt-8 space-y-4 sm:space-y-6" onSubmit={handleLogin}>
            <div className="space-y-4 sm:space-y-5">
              <div className="space-y-2">
                <label htmlFor="gstin" className="block text-xs sm:text-sm font-semibold text-slate-700 tracking-wide">GSTIN Number</label>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 pt-2">
              <div className="flex items-center group cursor-pointer">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 sm:h-5 sm:w-5 text-teal-600 focus:ring-teal-500 border-2 border-gray-300 rounded-lg cursor-pointer transition-all"
                  checked={rememberMe}
          ...
          <form className="mt-4 sm:mt-6 space-y-4 sm:space-y-6" onSubmit={(e) => { e.preventDefault(); resetPassword(); }}>
            <div>
              <label htmlFor="gstin" className="block text-xs sm:text-sm font-medium text-gray-700">GSTIN Number</label>
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  required
                  maxLength={15}
                  className="focus:ring-2 focus:ring-teal-500/50 focus:border-teal-500 block w-full pl-9 sm:pl-12 pr-4 py-2.5 sm:py-3.5 text-sm sm:text-base border-2 border-gray-200 rounded-xl shadow-sm placeholder-gray-400 text-slate-800 focus:outline-none bg-gradient-to-br from-gray-50 to-white focus:bg-white transition-all duration-200 uppercase"
                  placeholder="Enter GSTIN Number"
                  value={gstin}
                  onChange={(e) => setGstin(e.target.value.toUpperCase())}
                />
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  required
                  className="focus:ring-2 focus:ring-teal-500/50 focus:border-teal-500 block w-full pl-9 sm:pl-12 pr-4 py-2.5 sm:py-3.5 text-sm sm:text-base border-2 border-gray-200 rounded-xl shadow-sm placeholder-gray-400 text-slate-800 focus:outline-none bg-gradient-to-br from-gray-50 to-white focus:bg-white transition-all duration-200"
