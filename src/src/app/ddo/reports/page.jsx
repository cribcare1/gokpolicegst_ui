...
import { FileText, BarChart3, Download, Receipt } from 'lucide-react';
import Link from 'next/link';

export default function DDOReportsPage() {
  const reports = [
    {
      id: 'invoice',
    ...
    },
    {
      ...
      description: 'View payment and credit note reports',
      icon: FileText,
      color: 'bg-green-500',
      href: '/ddo/payment-report',
    },
    {
      id: 'summary',
      title: 'Summary Report',
      description: 'View summary and analytics',
      icon: BarChart3,
      color: 'bg-purple-500',
      href: '/ddo/reports/summary',
    },
  ];
